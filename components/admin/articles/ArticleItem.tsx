...
export const ArticleItem: FC<Props> = ({ article }) => {   
    ...
    return (
        <>
            <tr className='border-b hover:bg-slate-50 hover:shadow-inner'>
                ...
                <td className='text-left px-6 text-[1.4rem] min-w-[260px] overflow-x-hidden text-slate-800 py-4'>{ article.title }</td>
                <td className='text-left px-6 text-xl sm:text-[1.4rem] text-slate-800 font-bold'>{ article.category.title }</td>
                ...
                <td className='text-center px-6 text-[1.3rem] text-slate-800 font-semibold'>{ article.views }</td>
